(if (file-accessible-directory-p "$HOME/.lisp")
    (setq load-path (cons (expand-file-name "$HOME/.lisp")
			  load-path)))
...
(byte-compile-if-newer-and-load "$HOME/.lisp/toggle-source")
(byte-compile-if-newer-and-load "$HOME/.lisp/line-num")
(byte-compile-if-newer-and-load "$HOME/.lisp/matlab")
(byte-compile-if-newer-and-load "$HOME/.lisp/outline-magic")
(byte-compile-if-newer-and-load "$HOME/.lisp/doc-mode-1.1/doc-mode.el")
(byte-compile-if-newer-and-load "$HOME/.lisp/csharp-mode-0.4.0")
(byte-compile-if-newer-and-load "$HOME/.lisp/csv-mode")
(byte-compile-if-newer-and-load "$HOME/.lisp/org-outlook")
(byte-compile-if-newer-and-load "$HOME/.lisp/graphviz-dot-mode")
(byte-compile-if-newer-and-load "$HOME/.lisp/markdown-mode.el")
;(load-library "p4")
